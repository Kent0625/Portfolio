...
const SAMPLES: Sample[] = [
  { src: '/assets/projects/life-of-a-bill-poster.png', label: 'The Life of a Bill: ML Research Poster' },
  { src: '/assets/projects/coffee-income-poster.png', label: 'From Farm to Cup: Bootstrap Resampling Poster' },
  { src: '/GEN_AI/FINAL%20Research%20Poster%20.png', label: 'SmartTripCDO: RAG Assistant Architecture Poster' },
  { src: '/samples/thumbs/eda-workflow-suite.jpeg', label: 'EDA Studio: Data Profiling Pipeline' },
  { src: '/samples/thumbs/inventory-dss.jpeg', label: 'Inventory DSS: Reorder Diagnostic Dashboard' },
  { src: '/samples/thumbs/e-eye-screening.jpeg', label: 'E-Eye Retinal Screening Interface' },
]
  ...
  return (
    <section className="wfs" id="workflow-samples" aria-labelledby="wfs-heading" data-reveal>
      <p className="wfs__caption" id="wfs-heading">
        Visual proof, conference research posters, and interactive application interfaces across machine learning and statistical modeling studies.
      </p>
