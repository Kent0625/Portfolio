...
const EXTENSIONS: Extension[] = [
  {
    name: 'Senate Record ETL Pipeline',
    desc: 'Automated scraping and schema extraction pipeline indexing 7,352 bills from the Philippine Senate archive into structured datasets.',
    imageSrc: '/samples/thumbs/life-of-a-bill.jpeg',
    imageAlt: 'Philippine Senate legislative ETL pipeline interface',
    Icon: Key,
  },
  {
    name: 'EDA & Profiling Suite',
    desc: 'Standardized data hygiene framework scanning missingness, distributions, and outlier patterns across raw datasets.',
    imageSrc: '/samples/thumbs/eda-workflow-suite.jpeg',
    imageAlt: 'Automated exploratory data analysis suite interface',
    Icon: Browser,
  },
]
  ...
  return (
    ...
    >
      <header className="projects__header">
        <span className="projects__eyebrow">Machine Learning & Data Systems</span>
        <h2 className="projects__headline" id="projects-heading">
          Applied AI and statistical workflows.
        </h2>
        <p className="projects__subhead">
          End-to-end data pipelines, supervised classifiers, and deployed static RAG systems.
          Open any branch to see the technical stack and verification status.
        </p>
      </header>
