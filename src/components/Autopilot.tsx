  ...
  return (
    ...
    >
      ...
      <header className="autopilot__head">
        <span className="autopilot__eyebrow">End-to-End Pipeline</span>
        <h2 id="autopilot-heading" className="autopilot__headline">
          From ingestion to model inference.
        </h2>
        <p className="autopilot__intro">
          Automated data flow: raw ingestion from legislative archives or agricultural field records, automated profiling and vectorization in Python, supervised model training, and continuous deployment to interactive cloud spaces.
        </p>
      </header>
      )}
